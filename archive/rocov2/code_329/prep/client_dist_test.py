...
# Load the datasets
train_captions_df = pd.read_csv('../../test_captions.csv') # data type 에 따라 train/valid/test 로 변경
train_concepts_df = pd.read_csv('../../test_concepts.csv')
train_concepts_manual_df = pd.read_csv('../../test_concepts_manual.csv')
...
def save_client_data(client_id, data_type, df):
    ...
    file_path = os.path.join(dir_path, f'client_{client_id}_test_{data_type}.csv')
