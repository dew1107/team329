...
ImageFile.LOAD_TRUNCATED_IMAGES = True  # 손상 이미지도 best-effort 로드
...
METADATA_CSV = r"C:\Users\user\PycharmProjects\Mimic-cxr\team329\mimic-cxr\mimic-cxr-2.0.0-metadata.csv"  # 없으면 ""로
